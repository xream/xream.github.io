import"./chunks/assets.COeCtnMN.js";import{E as e,St as t,at as n,it as r,ot as i,st as a,tt as o,vt as s}from"./chunks/framework.DwjJr7zi.js";var c=JSON.parse(`{"title":"自动设置服务端证书 SHA-256 指纹","description":"","frontmatter":{"title":"自动设置服务端证书 SHA-256 指纹"},"headers":[],"relativePath":"blog/posts/1434.md","filePath":"blog/posts/1434.md","lastUpdated":1783382106000}`),l={name:`blog/posts/1434.md`},u={class:`telegram-content`};function d(e,c,l,d,f,p){let m=t(`TelegramCustomEmoji`);return s(),r(`div`,null,[c[2]||=o(`h1`,{id:`自动设置服务端证书-sha-256-指纹`,tabindex:`-1`},[i(`自动设置服务端证书 SHA-256 指纹 `),o(`a`,{class:`header-anchor`,href:`#自动设置服务端证书-sha-256-指纹`,"aria-label":`Permalink to “自动设置服务端证书 SHA-256 指纹”`},`​`)],-1),c[3]||=o(`img`,{class:`telegram-media`,src:`/telegram/AQADsQ5rG8NCoFZ-.jpg`,alt:`Telegram 图片`,loading:`lazy`,decoding:`async`},null,-1),o(`div`,u,[c[0]||=n(`<img class="telegram-custom-emoji" src="/telegram/AgADjgIAAvkj2EQ.webp" alt="🔗" loading="lazy" decoding="async"> <u>Sub-Store 自动设置服务端证书 SHA-256 指纹</u><br><br>仅 Node.js 版支持<br><br>优先使用 <code>sni</code>, 其次节点服务端<br>其他需求可以让 AI 改改. 比如哪些节点需要加之类的.<br>这里示范的是直接从服务端取, 支持所有目标(包括 <img class="telegram-custom-emoji" src="/telegram/AgAD8gMAAgz-iUc.webp" alt="📦" loading="lazy" decoding="async"> sing-box 的 <code>certificate_public_key_sha256</code>)<br><br><details class="telegram-blockquote-collapsible"><summary aria-label="展开或收起引用"><pre class="telegram-blockquote-content">const tls = require(&quot;tls&quot;);
